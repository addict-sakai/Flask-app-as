...
class IoFlight(db.Model):
    ...
    entrance_fee_paid    = db.Column(db.Boolean, nullable=False, default=False)    # 入山料入金確認
    yamachin_confirmed  = db.Column(db.Boolean, nullable=False, default=False)    # 山チン入金確認
